(function () {
  function q(a, b) {
    ...
    a.matches && a.matches(b) && c.splice(0, 0, a);
    return c;
  }
  function w(a) {
  ...
  function E(a) {
    ...
    (function c() {
      ...
      1 < (e += 0.1) || ((a.style.opacity = e), requestAnimationFrame(c));
    })();
  }
  function t(a) {
    var b = [],
  ...
  function F(a) {
    ...
    a.querySelectorAll(".carousel-item .col-md-12").forEach(function (a) {
      2 > c
        ...
        : a.setAttribute("class", "col-md-12 col-lg-" + 12 / c);
    });
    ...
    a.querySelectorAll(".carousel-item").forEach(function (a) {
      for (var b = a, m = 1; m < c; m++) {
        ...
        d.classList.add("cloneditem-" + m);
        d.classList.add("clonedCol");
        d.setAttribute("data-cloned-index", h);
  ...
  function G(a) {
    ...
    if (c) {
      for (var b = [], c = Array.from(c.children), e = 0; e < c.length; e++)
        b.push('"' + c[e].getAttribute("stop-color") + '"');
      b = '"lineargradient": [' + b + "],";
  ...
  function y(a, b, c) {
    ...
    Array.from(e.children).forEach(function (b) {
      switch (!0) {
        case b.matches("p"):
          b.innerText = c + "%";
          a.appendChild(b);
  ...
  n && (d = jQuery);
  d
    ? (k = d("html").hasClass("is-builder"))
    : (k = document.querySelector("html").classList.contains("is-builder"));
  Element.prototype.parents = function (a) {
    for (
      var b = [], c = this, e = void 0 !== a;
      null !== (c = c.parentElement);

    )
      c.nodeType === Node.ELEMENT_NODE && ((e && !c.matches(a)) || b.push(c));
    return b;
  };
  Element.prototype.footerReveal = function () {
    function a() {
      !e && b.offsetHeight <= window.outerHeight
        ? ((b.style.zIndex = "-999"),
          (b.style.position = "fixed"),
          (b.style.bottom = "0"),
          (b.style.width = c.offsetWidth + "px"),
          (c.style.marginBottom = b.offsetHeight + "px"))
        : ((b.style.zIndex = ""),
          (b.style.position = ""),
          (b.style.bottom = ""),
          (b.style.width = ""),
  ...
  (function (a) {
    var b = function (a, b, f) {
      ...
      return function () {
        var h = this,
          k = arguments;
        d ? clearTimeout(d) : f && a.apply(h, k);
  ...
  r(function () {
    function a(a) {
      a.style.height = (9 * x(a.parentNode)) / 16 + "px";
    }
    function b(a) {
      setTimeout(function () {
          ...
          if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
            if (c && /youtu\.?be/g.test(c[3])) {
              ...
              var b =
                ...
                b = b + ("//img.youtube.com/vi/" + c[6] + "/maxresdefault.jpg"),
                e = new Image();
              e.onload = function () {
                if (120 === (e.naturalWidth || e.width)) {
                  var b = e.src.split("/").pop();
                  switch (b) {
                    case "maxresdefault.jpg":
                      e.src = e.src.replace(b, "sddefault.jpg");
                      break;
                    case "sddefault.jpg":
                      e.src = e.src.replace(b, "hqdefault.jpg");
                      break;
                    default:
                      k &&
                  ...
                  (f.style.backgroundImage = 'url("' + e.src + '")'),
                    (f.style.display = "block");
                ...
                l.classList.add("mbr-video-foreground");
                l.appendChild(g);
                h.appendChild(l);
                d.appendChild(h);
                g.classList.add("mbr-background-video");
                a.childNodes[1].before(d);
                b = new YouTubePlayer(g, {
                  modestBranding: !0,
                  autoplay: !0,
                  controls: !1,
                  origin: "*",
                ...
                g.style.marginTop = "0";
                g.style.maxWidth = "initial";
                g.style.transitionProperty = "opacity";
                g.style.transitionDuration = "1000ms";
                ...
                var h = window.outerWidth,
                  ...
                  m = b._opts.width / b._opts.height,
                  g = h,
                  d = Math.ceil(g / m);
                Math.ceil(-((d - l) / 2));
                d < l &&
                  ((d = l), (g = Math.ceil(d * m)), Math.ceil(-((g - h) / 2)));
                b.setSize(g, d);
              };
              ...
              if (c && /vimeo/g.test(c[3])) {
                ...
                g.classList.add("mbr-background-video");
                a.childNodes[1].before(g);
                b = new Vimeo.Player(g, {
                  id: b,
                  loop: !0,
                  background: !0,
                  responsive: !0,
            ...
            g.style.transform = "translateX(-50%) translateY(-50%)";
            b = "";
    ...
    t() && navigator.userAgent.match(/Chrome/i)
      ? (function (a, b) {
          var c = [a, a];
          c[b > a ? 0 : 1] = b;
      ...
      : I ||
        ...
        document.addEventListener("add.cards", function (a) {
          document
            ...
            q(a.target, ".mbr-section--full-height").length &&
    ...
    if (n)
      d(document).on("add.cards changeParameter.cards", function (b) {
        var c = q(b.target, ".mbr-section--16by9");
        c.length
          ? c.forEach(function (b) {
              b.setAttribute("data-16by9", "true");
              a(b);
            })
          : q(b.target, "[data-16by9]").forEach(function (a) {
              a.styles.height = "";
              a.removeAttribute("data-16by9");
            });
      });
    if ("undefined" !== typeof jarallax && !t()) {
      ...
      if (k) {
        ...
        d(document).on("changeParameter.cards", function (a, c, f, e) {
          if ("bg" === c)
            switch (
              ((c = a.target),
              jarallax && jarallax(c, "destroy"),
              (c.style.position = ""),
              d(a.target).find(".mbr-background-video-preview").remove(),
              d(a.target).find(".mbr-background-video").remove(),
              e)
            ) {
              case "type":
                !0 === f.parallax && b(a.target);
                break;
              case "value":
                "image" === f.type && !0 === f.parallax && b(a.target);
                break;
              case "parallax":
                !0 === f.parallax && b(a.target);
            }
    ...
    window.addEventListener("scroll", function () {
      ...
      m = a;
      if (h) {
        var c = a > h.breakPoint;
        b
          ? c != h.fixed &&
            (B
              ? ((h.fixed = c), h.elm.classList.toggle("is-fixed"))
    ...
    window.smartresize(function () {
      document.querySelectorAll(".mbr-embedded-video").forEach(function (a) {
        a.style.height =
          (
            (x(a) * parseInt(a.getAttribute("height") || 315)) /
    ...
    if (k)
      d(document).on("changeParameter.cards", function (a, b, f, e) {
        if ("bg" === b)
          switch (e) {
            case "type":
              "video" === f.type && c(a.target);
              break;
            case "value":
              "video" === f.type && c(a.target);
          }
            ...
            do
              if (b.hash) {
                ...
                document
                  ...
                  .forEach(function (c) {
                    a.preventDefault();
                    var f = document.querySelector(".navbar-fixed-top"),
                      f =
                        "#bottom" == b.hash
                          ? u(c) - window.innerHeight
                          : w(c).top - (f ? 60 : 0);
        ...
        function b() {
          ...
          if (d && e) {
            ...
            m > h &&
              ((h = (100 * (m - h)) / h),
              (c.style.width = h + 100 + "%"),
              (c.style.maxWidth = h + 100 + "%"),
              (c.style.marginLeft = -h / 2 + "%"));
          }
        }
  ...
  if (!k) {
    if (n && d.fn.socialLikes)
      d(document).on("add.cards", function (a) {
        q(a.target, ".mbr-social-likes").forEach(function (a) {
          a.addEventListener("counter.social-likes", function (a, b, f) {
            999 < f &&
              a.target
                .querySelectorAll(".social-likes__counter")
                .forEach(function (a) {
                  a.innerHTML = Math.floor(f / 1e3) + "k";
                });
          });
  ...
  r(function () {
    if (document.querySelectorAll(".mbr-arrow-up").length) {
      ...
      a.style.display = "none";
      window.addEventListener("scroll", function () {
        window.scrollY > window.innerHeight ? E(a) : D(a);
      });
  ...
  document.querySelectorAll("nav.navbar").length &&
    ((p = u(document.querySelector("nav.navbar"))),
  ...
  r(function () {
    if (!k) {
      var a = function (a) {
        ...
        b = function (b) {
          var e = b.parents("section")[0].querySelector("iframe"),
          ...
          if (f) {
            if (
              ...
              var d = new Vimeo.Player(e);
              d.play();
            }
          } else {
            var h = e.parentNode.querySelector("video");
            h && h.play && h.play();
          }
            ...
            "VIDEO" !== b.target.tagName &&
              (f
                ? (-1 !== f.indexOf("youtu") &&
                  ...
                  -1 !== f.indexOf("vimeo") && d.pause())
                : (b = e.parentNode.querySelector("video")) &&
                  b.pause &&
                  b.pause(),
  ...
  if (!k) {
    var p = document.querySelectorAll(".dropdown-toggle.show"),
      z = document.querySelectorAll(".dropdown-menu.show, .dropdown.open"),
    ...
    !t() &&
      (p = document.querySelector("section.menu")) &&
      ((z = window.innerWidth),
      !p.querySelector(".navbar").classList.contains("collapsed") &&
        991 < z &&
  ...
  k ||
    ("undefined" === typeof window.initClientPlugin &&
      ...
      document.body.querySelectorAll(".clients").forEach(function (a) {
        a.getAttribute("data-isinit") || (v(a), F(a));
      })),
      ...
      document
        ...
        .forEach(function (a) {
          a.addEventListener("click", function () {
            ...
            !c.classList.contains("collapsing") ||
  ...
  document.querySelectorAll('input[type="range"]').forEach(function (a) {
    a.addEventListener("change", function (a) {
      a.target.parents(".form-group").forEach(function (c) {
        c.querySelector(".value").innerHTML = a.target.value;
      });
    });
  });
  if (k)
    d(document).on("add.cards changeParameter.cards", function (a, b) {
  ...
  if (k && n)
    d(document)
      .on("add.cards", function (a) {
        d(a.target).hasClass("testimonials-slider") && v(a.target);
      })
      .on("changeParameter.cards", function (a, b, c) {
        "testimonialsSlides" === b &&
          0 == d(a.target).find(".carousel-item.active").length &&
          A(a.target);
      });
  else
    "undefined" === typeof window.initTestimonialsPlugin &&
